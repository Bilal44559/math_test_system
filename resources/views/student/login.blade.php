                ...
                <div class="col-lg-4 col-md-7">
                    <div class="card border-0 mb-0">
                        ...
                        <div class="card-body px-lg-5 pt-0">
                            <form method="POST" action="{{ route('student.submit-login') }}" role="form" class="text-start">
                                @csrf
                                <div class="mb-3">
                                    <input type="email" id="email"
                                        class="form-control @error('email') is-invalid @enderror"
                                        value="{{ session('email', old('email')) }}" name="email" placeholder="Email" aria-label="Email"
